...
public class mine extends Block implements ITileEntityProvider {

	private tileMine mte;
    ...
    public void explode(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase igniter)
    {
        if (!worldIn.isRemote)
        {
            tileMine m = (tileMine)worldIn.getTileEntity(pos);
            this.mte = m;
            m.explode();
        }
    }
