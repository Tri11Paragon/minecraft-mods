...
public class mcreator_dDDD {

public mcreator_dDDD(){}
...
static{
block = (Item)(new BlockCustomFood(4, 0.3F, true));block = ((BlockCustomFood)block).setUnlocalizedName("DDDD").setTextureName("sda");
block.setMaxStackSize(64);
Item.itemRegistry.addObject(424, "DDDD", block);
...
if(true){
if(entity instanceof EntityLivingBase) ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(1, 300, 2));
}
