...
import net.minecraft.client.Hacks;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if(Hacks.Menu){
        	var8.drawString("Menu: ", 2, 2, 0xFF0000);
        	if(Hacks.Something){
        	var8.drawString("Something[o]", 2, 12, 0xFF0000);
        	} else {
        		var8.drawString("Something[o]", 2, 12, 0x00FF00);
        	}
        	var8.drawString("xRay[x]", 2, 22, 0xFF0000);
        	var8.drawString("Step[c]", 2, 32, 0xFF0000);
        	var8.drawString("Arrows[p]", 2, 42, 0xFF0000);
        	var8.drawString("Highjump[b]", 2, 52, 0xFF0000);
        }
