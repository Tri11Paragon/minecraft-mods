        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if(Keyboard.getEventKey() == 50){
                	Hacks.Menu=true;
                	System.out.println(Hacks.Menu + "Menu");
                ...
                if(Keyboard.getEventKey() == 48){
                	Hacks.HighJump=true;
                	System.out.println(Hacks.HighJump + "HighJump");
                }else if(Keyboard.getEventKey() == 28){
                	Hacks.HighJump=false;
                	System.out.println(Hacks.HighJump + "HighJump");
                }
                //
                if(Keyboard.getEventKey() == 25){
                	Hacks.Arrows=true;
                	System.out.println(Hacks.Arrows + "Arrows");
                }else if(Keyboard.getEventKey() == 28){
                	Hacks.Arrows=false;
                	System.out.println(Hacks.Arrows + "Arrows");
                }
                ...
                if(Keyboard.getEventKey() == 24){
                	Hacks.Something=true;
                	System.out.println(Hacks.Something + "Something");
                } else if(Keyboard.getEventKey() == 28){
                	Hacks.Something=false;
                	System.out.println(Hacks.Something + "Something");
                }
                
                if(Keyboard.getEventKey() == 46){
                	Hacks.Step=true;
                	System.out.println(Hacks.Step + "Step");
                }else if(Keyboard.getEventKey() == 28){
                	Hacks.Step=false;
                	System.out.println(Hacks.Step + "Step");
                }
                if(Keyboard.getEventKey() == 45){
                	Hacks.xRay=true;
                	System.out.println(Hacks.xRay + "xRay");
                } else if(Keyboard.getEventKey() == 28){
                	Hacks.xRay=false;
                	System.out.println(Hacks.xRay + "xRay");
                }
