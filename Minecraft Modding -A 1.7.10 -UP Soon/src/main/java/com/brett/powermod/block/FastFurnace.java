...
public class FastFurnace extends BlockContainer
{
    ...
    public FastFurnace(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(MainClass.FastFurnaceOff);
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
            TileEntityFastFurnace tileentityfurnace = (TileEntityFastFurnace)p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);

            if (tileentityfurnace != null)
            {
            	//p_149727_5_.func_146101_a(tileentityfurnace);
                tileentityfurnace.openInventory();
    ...
    public void func_146101_a(TileEntityFastFurnace p_146101_1_) {}
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityFastFurnace)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            TileEntityFastFurnace tileentityfurnace = (TileEntityFastFurnace)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
