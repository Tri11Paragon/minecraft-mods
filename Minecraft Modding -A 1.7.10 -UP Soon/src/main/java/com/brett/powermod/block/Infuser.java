...
public class Infuser extends BlockContainer {
	...
	public Infuser(boolean isActive) {
		super(Material.rock);
		isBurning2 = isActive;
	}
	...
	public void registerBlockIcons(IIconRegister iconregister) {
		this.blockIcon = iconregister.registerIcon(MainClass.MODID + ":InfuserSide");
		this.front = iconregister.registerIcon(this.isBurning2 ? MainClass.MODID + ":InfuserActive" : MainClass.MODID + ":InfuserInactive");
		this.top = iconregister.registerIcon(MainClass.MODID + ":InfuserTop");
	}
	...
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(MainClass.Infuser);
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemstack) {
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityInfuser) world.getTileEntity(x, y, z)).furnaceName(itemstack.getDisplayName());
		}
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
		if (!isBurning) {
			TileEntityInfuser tileentitytutfurnace = (TileEntityInfuser) world.getTileEntity(x, y, z);
