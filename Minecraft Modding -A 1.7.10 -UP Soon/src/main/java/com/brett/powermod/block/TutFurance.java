...
public class TutFurance extends BlockContainer {
	...
	public TutFurance(boolean isActive) {
		super(Material.rock);
		isBurning2 = isActive;
	}
	...
	public void registerBlockIcons(IIconRegister iconregister) {
		this.blockIcon = iconregister.registerIcon(MainClass.MODID + ":TutFurnaceSide");
		this.front = iconregister.registerIcon(this.isBurning2 ? MainClass.MODID + ":TutFurnaceActive" : MainClass.MODID + ":TutFurnaceInactive");
		this.top = iconregister.registerIcon(MainClass.MODID + ":TutFurnaceTop");
	}
	...
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(MainClass.tutFurnace);
	}
	...
	public static void updateBlockState(boolean burning, World world, int x, int y, int z) {
		...
		if (burning) {
			world.setBlock(x, y, z, MainClass.tutFurnaceActive);
		} else {
			world.setBlock(x, y, z, MainClass.tutFurnace);
		}
