package com.brett.powermod.helpers;
...
public class WorldGenAir extends WorldGenerator
{
    ...
    public WorldGenAir(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.air);
    }

    public WorldGenAir(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenAir(Block block, int meta, int number, Block target)
    {
