...
public class WorldGenEndstone extends WorldGenerator
{
    ...
    public WorldGenEndstone(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.end_stone);
    }

    public WorldGenEndstone(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenEndstone(Block block, int meta, int number, Block target)
    {
