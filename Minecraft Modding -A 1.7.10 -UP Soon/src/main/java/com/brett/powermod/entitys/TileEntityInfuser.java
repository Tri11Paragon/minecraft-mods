package com.brett.powermod.entitys;
...
import com.brett.powermod.InfuserRecipes;
import com.brett.powermod.MainClass;
import com.brett.powermod.TutFurnaceRecipes;
...
public class TileEntityInfuser extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Infuser";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			Infuser.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null || this.furnaceItemStacks[3] == null) {
			...
			ItemStack itemstack2 = InfuserRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[3]);
			if (itemstack == null || itemstack2 == null) return false;
			if (this.furnaceItemStacks[2] == null) return true;
			if (!this.furnaceItemStacks[2].isItemEqual(itemstack) || !this.furnaceItemStacks[2].isItemEqual(itemstack2)) return false;
