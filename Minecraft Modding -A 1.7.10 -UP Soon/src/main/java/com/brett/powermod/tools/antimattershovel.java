...
public class antimattershovel extends ItemSpade {

	public antimattershovel(ToolMaterial p_i45347_1_) {
		super(p_i45347_1_);
		setTextureName(MainClass.MODID + ":antishovel");
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par4) {
    	list.add(EnumChatFormatting.DARK_BLUE + "Annihilates All Mater");
