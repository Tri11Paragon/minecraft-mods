...
public class TestEnvironmentMod implements IFuelHandler, IWorldGenerator{
	...
	mcreator_dad mcreator_0 = new mcreator_dad();
mcreator_sadasd mcreator_1 = new mcreator_sadasd();
mcreator_tEst mcreator_2 = new mcreator_tEst();
mcreator_tests mcreator_3 = new mcreator_tests();
mcreator_bLOCKBREAKER mcreator_4 = new mcreator_bLOCKBREAKER();
