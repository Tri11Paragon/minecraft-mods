...
static{
block = (new ItemgGUN());
Item.itemRegistry.addObject(424, "tEst", block);
}
...
public int getMaxItemUseDuration(ItemStack par1ItemStack)
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, final EntityPlayer par3EntityPlayer){
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Items.diamond))
        {
            float f = 1.5F;
            ...
            {
                par3EntityPlayer.inventory.consumeInventoryItem(Items.diamond);
            }
