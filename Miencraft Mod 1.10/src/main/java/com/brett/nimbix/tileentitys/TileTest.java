...
public class TileTest extends TileEntity implements IInventory, IEnergyProvider, ITickable {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "Uses Redstone - Will Work!";
	}
