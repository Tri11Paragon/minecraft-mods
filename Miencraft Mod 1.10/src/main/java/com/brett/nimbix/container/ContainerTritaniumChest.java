...
public class ContainerTritaniumChest extends Container {
	
	private TileTritaniumChest te;
	
	public ContainerTritaniumChest(IInventory playerInv, TileTritaniumChest te) {
		this.te = te;
