...
public class GUIPowerGenerator extends GuiContainer{
	...
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(MainClass.MODID + ":textures/collector.png");
	private PowerGenerator tileFurnace;

	public GUIPowerGenerator(InventoryPlayer invPlayer, PowerGenerator tile) {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		...
		//this.fontRendererObj.drawString(I18n.format("", new Object[0]), 8, this.ySize - 94, 4210752); 
		this.fontRendererObj.drawString("EME In Storage: " + tileFurnace.EMEValue, 50, 60, 4210752);
	}
