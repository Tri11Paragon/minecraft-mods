...
public class EntityTippedArrowE extends EntityArrowE
{
    private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(EntityTippedArrowE.class, DataSerializers.VARINT);
    private PotionType potion = PotionTypes.EMPTY;
    private final Set<PotionEffect> customPotionEffects = Sets.<PotionEffect>newHashSet();

    public EntityTippedArrowE(World worldIn)
    {
        super(worldIn);
    }

    public EntityTippedArrowE(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }

    public EntityTippedArrowE(World worldIn, EntityLivingBase shooter)
    {
    ...
    {
        EntityArrowE.func_189657_a(p_189660_0_, "TippedArrow");
    }
