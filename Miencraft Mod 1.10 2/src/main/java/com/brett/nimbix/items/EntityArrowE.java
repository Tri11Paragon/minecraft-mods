...
public abstract class EntityArrowE extends EntityArrow implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityArrowE.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityArrowE.PickupStatus pickupStatus;
    ...
    public EntityArrowE(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityArrowE.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
        this.setSize(0.5F, 0.5F);
    }

    public EntityArrowE(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public EntityArrowE(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntityArrowE.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityArrowE.PickupStatus.ALLOWED)
                    {
    ...
    {
    	//this.worldObj.createExplosion(living, this.posX, this.posY, this.posZ, 20, false);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityArrowE.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityArrowE.PickupStatus.ALLOWED : EntityArrowE.PickupStatus.DISALLOWED;
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityArrowE.PickupStatus.ALLOWED || this.pickupStatus == EntityArrowE.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityArrowE.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityArrowE.PickupStatus getByOrdinal(int ordinal)
        {
