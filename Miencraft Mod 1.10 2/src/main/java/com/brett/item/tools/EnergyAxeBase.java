...
public class EnergyAxeBase extends ItemAxe implements IEnergyContainerItem {
    ...
    protected EnergyAxeBase(Item.ToolMaterial material, int usage, int maxStorage, int[] allowedInts, Set effectiveBlocks)
    {
	...
	static int curCool = 0;
	static int coo = 100;
	/*public static void keyPressed(){
		if(isShiftKeyDown() && curCool <= 0){
    ...
    public static boolean isShiftKeyDown() {
        return KeyBindings.AOESize.isKeyDown();
    }
	
	public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean par4)
	{	
		list.add(ChatFormatting.DARK_GREEN + "Just your normal super axe");
