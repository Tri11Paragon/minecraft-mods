...
block = (BlockTTT)(new BlockTTT().setHardness(2.0F)
.setResistance(10.0F)
.setLightLevel(0.0F)
.setBlockName("TTT")
.setBlockTextureName("d")
.setLightOpacity(0)
.setStepSound(Block.soundTypeStone)
.setCreativeTab(CreativeTabs.tabBlock)
);block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
Block.blockRegistry.addObject(178, "TTT", block);
block.setHarvestLevel("pickaxe", 0);
}

public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
public void generateNether(World world, Random random, int chunkX, int chunkZ){}
static class BlockTTT extends Block
{
...
this.gor = reg.registerIcon("d");
this.dol = reg.registerIcon("d");
this.st1 = reg.registerIcon("d");
this.st2 = reg.registerIcon("d");
this.st3 = reg.registerIcon("d");
this.st4 = reg.registerIcon("d");
}
